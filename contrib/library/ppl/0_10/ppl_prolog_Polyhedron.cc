...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_intersection_assign_and_minimize";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    PPL_CHECK(rhs);
    if (lhs->intersection_assign_and_minimize(*rhs))
      return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
extern "C" Prolog_foreign_return_type
  ...
  (Prolog_term_ref t_lhs, Prolog_term_ref t_rhs) {
  static const char* where = "ppl_Polyhedron_poly_hull_assign_and_minimize";
  try {
    Polyhedron* lhs = term_to_handle<Polyhedron >(t_lhs, where);
    const Polyhedron* rhs = term_to_handle<Polyhedron >(t_rhs, where);
    PPL_CHECK(lhs);
    PPL_CHECK(rhs);
    if (lhs->poly_hull_assign_and_minimize(*rhs))
      return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_add_constraint_and_minimize(Prolog_term_ref t_ph,
                                               Prolog_term_ref t_c) {
  static const char* where = "ppl_Polyhedron_add_constraint_and_minimize/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    if (ph->add_constraint_and_minimize(build_constraint(t_c, where)))
      return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_add_congruence_and_minimize(Prolog_term_ref t_ph,
                                               Prolog_term_ref t_c) {
  static const char* where = "ppl_Polyhedron_add_congruence_and_minimize/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    if (ph->add_congruence_and_minimize(build_congruence(t_c, where)))
      return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_add_generator_and_minimize(Prolog_term_ref t_ph,
                                               Prolog_term_ref t_c) {
  static const char* where = "ppl_Polyhedron_add_generator_and_minimize/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    if (ph->add_generator_and_minimize(build_generator(t_c, where)))
      return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_add_constraints_and_minimize(Prolog_term_ref t_ph,
                                                Prolog_term_ref t_clist) {
  static const char* where = "ppl_Polyhedron_add_constraints_and_minimize/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    Constraint_System cs;
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_add_congruences_and_minimize(Prolog_term_ref t_ph,
                                                Prolog_term_ref t_clist) {
  static const char* where = "ppl_Polyhedron_add_congruences_and_minimize/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    Congruence_System cs;
    ...
    if (ph->add_congruences_and_minimize(cs))
      return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
...
extern "C" Prolog_foreign_return_type
  ppl_Polyhedron_add_generators_and_minimize(Prolog_term_ref t_ph,
                                                Prolog_term_ref t_clist) {
  static const char* where = "ppl_Polyhedron_add_generators_and_minimize/2";
  try {
    Polyhedron* ph = term_to_handle<Polyhedron >(t_ph, where);
    PPL_CHECK(ph);
    Generator_System cs;
    ...
    if (ph->add_generators_and_minimize(cs))
      return PROLOG_SUCCESS;
  }
  CATCH_ALL;
}
