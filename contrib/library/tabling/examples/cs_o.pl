...
horizontalcut__1(_355) :- 
        [_326] = _357, 
        cuth([_314]),
	%display('Devuelve '), display(cuth([_314])), nl,
        horizontal([_318]),
	%display('Devuelve '), display(horizontal([_318])), nl,
        wasteh([_322]),
	%display('Devuelve '), display(wasteh([_322])), nl,
	%display('Llama a '), display(gencut([_314],[_318],[_322],[_326])), nl,
        gencut([_314],[_318],[_322],[_326]),
	%display('Devuelve '), display(gencut([_314],[_318],[_322],[_326])), nl,
...
result([quantity([atom]),empty([atom]),cuth([atom]),cutv([atom]),wasteh([num]),wastev([num]),vertical([num]),
	horizontal([num]),member([A],[B,list]),append([list],[A],[A]),append([list],[A],[A,list]),
	find([A],[B,list],[C]),addliste([list],[A],[A]),addliste([list],[A,list],[A,list]),
	...
	split([list],[list],[list]),genempty([list],[list]),combcutaux([A],[B],[list],[C],[A],[num]),
	...
	combcutaux([list],[list],[list],[list],[list],[num]),combcut([A],[list],[B,list],[A],[num],[list]),
	combcut([A],[list],[list],[A],[num],[list]),combcut([A,list],[list],[B,list],[A,list],[num],[list]),
	combcut([A,list],[list],[list],[A,list],[num],[list]),combcut([list],[list],[A,list],[list],[num],[list]),
	combcut([list],[list],[list],[list],[num],[list]),combine([list],[A,list],[B],[list]),
	combine([list],[list],[A],[list]),combine([list],[A,list],[B,list],[list]),combine([list],[list],[A,list],[list]),
	combine([list],[A,list],[list],[list]),combine([list],[list],[list],[list]),nobeter([A],[list]),
	nobeter([num],[list]),nobeter([A],[list],[num]),nobeter([num],[list],[num]),nobeter([A],[list],[B]),
	generatecutaux([A],[num],[num],[num],[num],[list],[list],[num],[num]),
