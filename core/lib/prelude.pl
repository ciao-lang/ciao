:- package(prelude).
% TODO: move to initial; prelude should be empty first, then update bootstrap, then; 'nonpure' should be 'prelude'

% TODO: low-level declarations (dynamic or multifile may later be
