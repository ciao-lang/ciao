...
sensitive_builtin(messages_basic,warning,1,0) .
sensitive_builtin(messages_basic,note,1,0) .
sensitive_builtin(messages_basic,message,1,0) .
sensitive_builtin(messages_basic,debug,1,0) .
