...
:- doc(title, "HTTP client").
:- doc(author, "Daniel Cabeza").

:- doc(module, "This module implements a simple client for the
   @concept{HTTP} protocol, which allows retrieving data from HTTP
   servers.").
